...
\cventry{September 2014--Present}{Senior Software Engineer}{EXADS}{Dublin}{}{EXADS provides a 360 degrees solution to advertising networks, advertisers and publishers to manage large volumes of advertising inventory and maximize revenue.\newline{}
{\bfseries Key Projects}:
\begin{itemize}
\item {\bfseries EXADS} (\httplink[https://www.exads.com/]{https://www.exads.com/}):
  \begin{itemize}
  \item Exads provides services to some of the bigest Ad-serving companies in the world.
  \end{itemize}
\end{itemize}
{\bfseries \textit{As Senior Sotware Engineer I am responsible for}}\newline{}
Develop new applications and services used in the backend that are then consumed by other EXADS internal services that provide rich data to dashboards and statistics. I am also responsible to write system applications.\newline{}
...
\cventry{December 2013--September 2014}{Backend Development Team Leader}{Dedsert Ltd}{Dublin}{}{
...
Coordinate the development team, conduit the Scrum methodology, design and review the architecture of the software and improve the system with optmizations, fixes and proposals. Design and maintain the AWS infrastructure\newline{}
{\bfseries \textit{Key Technology Used}}\newline{}
...
\cvlistitem{Python, PHP, Go, JavaScript, C/C++}
\subsection{Web Related}
\cvlistitem{CSS3, HTML5}
\subsection{Ajax}
\cvlistitem{ExtJS, jQuery, Pure JavaScript}
\subsection{Frameworks}
\cvlistitem{Django, Symfony 1.2, Twisted, Play2 (Scala), Mamba}
\subsection{IDE}
\cvlistitem{Eclipse, QtCreator}
\subsection{Text Editors}
\cvlistitem{vi, Sublime Text 2/3}
...
\subsection{Cloud}
\cvlistitem{Amazon Web Services}
