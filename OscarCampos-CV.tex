...
\address{Mendiola Bidea 6, 1-A}{20110 Pasai Trintxerpe, Gipuzkoa, Spain}
\mobile{+34 622 622 046}
\phone{+34 843 982 218 (preferred)}
...
\cventry{2011--Present}{Senior Software Developer}{Webalianza IT S.L.}{San Sebastian}{}{Webalianza is an IT Consulting company with more than thirteen years of experience in the IT market of Basque Country with important clients in the research and science like CIC nanoGUNE (\httplink[]{http://www.nanogune.eu/en}). Webalianza main products are based on ExtJS, PHP, Scala, VMWare, Unix, Linux, NetAPP and Cisco technologies.\newline{}
...
I am responsible of developing all those projects as part of a small team of two developers and one system administrator. I am also responsible for the correct implementation of the SCRUM methodology for the GNE project. I used Python, Scala, PHP, JavaScript, CSS and HTML in those projects.\newline{}
...
\cvlistitem{Django, Symfony 1.2, Goliat, Play2 (Scala)}
\subsection{IDE}
...
{\bfseries Contribution}\newline{}
I added some Python Refactor features, fix some PEP-8 mistakes, moved some code to non-block Threadign environment added new features and fixed some bugs. I am already a regular commiter for this project.\newline{}
{\bfseries Project URL}\newline{}
